@echo off
rem -------------------------------------------------------------------
rem lyrgit_config_global_add_safe.directory.bat
rem ----------------------------------------------------------------------------
...
:begin
echo ---------------------------------------------------------------
echo git config --global --add safe.directory D:/PROJECTS_LYR/CHECK_LIST/05_DESKTOP/02_Python/PROJECTS_PY/TESTGIT
echo ---------------------------------------------------------------
git config --global --add safe.directory D:/PROJECTS_LYR/CHECK_LIST/05_DESKTOP/02_Python/PROJECTS_PY/TESTGIT
