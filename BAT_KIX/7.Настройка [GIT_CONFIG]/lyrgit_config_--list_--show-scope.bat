@echo off
rem -------------------------------------------------------------------
rem lyrgit_config_--list_--show-scope.bat
rem ----------------------------------------------------------------------------
rem 
rem ----------------------------------------------------------------------------
...
echo ----------------------------------------------------------------------------
rem git config --list                       > ./GIT_CONFIG_list_ss_ss
git config --list --show-scope          > ./GIT_CONFIG_list_ss_ss_current
rem git config --list --show-scope --global > ./GIT_CONFIG_list_ss_ss_global
rem git config --list --show-scope --local  > ./GIT_CONFIG_list_ss_ss_local
rem git config --list --show-scope --system > ./GIT_CONFIG_list_ss_ss_system
