@echo off
rem -------------------------------------------------------------------
rem lyrgit_config_-l_--show-origin.bat
rem ----------------------------------------------------------------------------
rem 
rem ----------------------------------------------------------------------------
...
echo ----------------------------------------------------------------------------
rem git config -l                        > ./GIT_CONFIG_l_so_so
git config -l --show-origin          > ./GIT_CONFIG_l_so_so_current
rem git config -l --show-origin --global > ./GIT_CONFIG_l_so_so_global
rem git config -l --show-origin --local  > ./GIT_CONFIG_l_so_so_local
rem git config -l --show-origin --system > ./GIT_CONFIG_l_so_so_system
