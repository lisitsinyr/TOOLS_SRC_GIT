@echo off
rem -------------------------------------------------------------------
rem lyrgit_config_-l_--show-scope.bat
rem ----------------------------------------------------------------------------
rem 
rem ----------------------------------------------------------------------------
...
echo ----------------------------------------------------------------------------
rem git config -l                       > ./GIT_CONFIG_l_ss_ss
git config -l --show-scope          > ./GIT_CONFIG_l_ss_ss_current
rem git config -l --show-scope --global > ./GIT_CONFIG_l_ss_ss_global
rem git config -l --show-scope --local  > ./GIT_CONFIG_l_ss_ss_local
rem git config -l --show-scope --system > ./GIT_CONFIG_l_ss_ss_system
