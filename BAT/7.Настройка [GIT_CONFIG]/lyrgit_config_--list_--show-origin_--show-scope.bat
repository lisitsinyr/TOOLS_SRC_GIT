@echo off
rem -------------------------------------------------------------------
rem lyrgit_config_--list_--show-origin_--show-scope.bat
rem ----------------------------------------------------------------------------
rem 
rem ----------------------------------------------------------------------------
...
echo ----------------------------------------------------------------------------
rem git config --list                                     > ./GIT_CONFIG_list_so_ss
git config --list --show-origin --show-scope          > ./GIT_CONFIG_list_so_ss_current
rem git config --list --show-origin --show-scope --global > ./GIT_CONFIG_list_so_ss_global
rem git config --list --show-origin --show-scope --local  > ./GIT_CONFIG_list_so_ss_local
rem git config --list --show-origin --show-scope --system > ./GIT_CONFIG_list_so_ss_system
