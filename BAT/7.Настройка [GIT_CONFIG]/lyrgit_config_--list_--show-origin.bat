@echo off
rem -------------------------------------------------------------------
rem lyrgit_config_--list_--show-origin.bat
rem ----------------------------------------------------------------------------
rem 
rem ----------------------------------------------------------------------------
...
echo ----------------------------------------------------------------------------
rem git config --list                        > ./GIT_CONFIG_list_so_so
git config --list --show-origin          > ./GIT_CONFIG_list_so_so_current
rem git config --list --show-origin --global > ./GIT_CONFIG_list_so_so_global
rem git config --list --show-origin --local  > ./GIT_CONFIG_list_so_so_local
rem git config --list --show-origin --system > ./GIT_CONFIG_list_so_so_system
